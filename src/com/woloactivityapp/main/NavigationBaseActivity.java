...
import com.woloactivityapp.navigation.NavigationActivity;

public class NavigationBaseActivity extends NavigationActivity implements OnClickListener {
	...
	public int getWidth() {
		SharedPreferences pref = NavigationBaseActivity.this.getSharedPreferences("com.woloactivityapp.main", 0);
